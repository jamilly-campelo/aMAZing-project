...
class Maze {
    ...
    public:
        ...
        enum cell_type : int {
            ...
            PATH      //!< A cell that has been marked as part of the path that leads from the maze's entry point to the maze's exit point.
        };
        ...
        /// Return `true` if the neighbor cell towards the requested direction is a wall; returns `false` otherwise.
        /*!
         * @param pos The position we are coming from.
         * @param dir The direction we want to go to.
         * @return `true` if the cell towards the requested direction is a wall, `false` otherwise.
         */
        ...
        /// Checks whether a cell is marked as part of the path that leads to the exit (solution).
